...
public enum GenerateHugeArrays {
	...
	public static byte[] dumpArrayList(final TypeModel tm) {
		...
		cw.visit(V1_5, ACC_PUBLIC + ACC_SUPER, name + "ArrayList", "L" + collections + "impl/AbstractHugeArrayList<L"
		...
		for (final FieldModel fm : tm.fields()) {
			if (fm instanceof Enum8FieldModel) {
				fv = cw.visitField(ACC_FINAL, fm.fieldName() + "FieldModel", "L" + collections
						+ "model/Enum8FieldModel;", "L" + collections
						+ "model/Enum8FieldModel<Ljava/lang/annotation/ElementType;>;", null);
				fv.visitEnd();
			} else if (fm instanceof Enumerated16FieldModel) {
				fv = cw.visitField(ACC_FINAL, fm.fieldName() + "FieldModel", "L" + collections
						+ "model/Enumerated16FieldModel;", "L" + collections
						+ "model/Enumerated16FieldModel<Ljava/lang/String;>;", null);
				fv.visitEnd();
			}
		}
		final List<FieldModel> fields = new ArrayList<FieldModel>();
		{
			...
			mv.visitMethodInsn(INVOKESPECIAL, collections + "impl/AbstractHugeArrayList", "<init>", "(L" + collections
					+ "HugeArrayBuilder;)V");
		...
		{
			mv = cw.visitMethod(ACC_PROTECTED, "createAllocation", "(L" + collections + "impl/MappedFileChannel;)L"
					+ name + "Allocation;", null, null);
			mv.visitCode();
			final Label l0 = new Label();
			mv.visitLabel(l0);
			...
			mv.visitVarInsn(ALOAD, 1);
			mv.visitMethodInsn(INVOKESPECIAL, name + "Allocation", "<init>", "(IL" + collections
					+ "impl/MappedFileChannel;)V");
		...
		}
		{
			...
			mv.visitMethodInsn(INVOKESPECIAL, name + "Element", "<init>", "(L" + collections
					+ "impl/AbstractHugeArrayList;J)V");
			mv.visitInsn(ARETURN);
			final Label l1 = new Label();
			mv.visitLabel(l1);
			mv.visitLocalVariable("this", "L" + name + "ArrayList;", null, l0, l1, 0);
		...
		{
			mv = cw.visitMethod(ACC_PROTECTED + ACC_BRIDGE + ACC_SYNTHETIC, "createImpl", "()Ljava/lang/Object;", null,
					null);
			mv.visitCode();
			final Label l0 = new Label();
			mv.visitLabel(l0);
		...
		{
			mv = cw.visitMethod(ACC_PROTECTED + ACC_BRIDGE + ACC_SYNTHETIC, "createElement", "(J)L" + collections
					+ "impl/AbstractHugeElement;", null, null);
			mv.visitCode();
			final Label l0 = new Label();
			mv.visitLabel(l0);
			mv.visitLineNumber(29, l0);
		...
		{
			mv = cw.visitMethod(ACC_PROTECTED + ACC_BRIDGE + ACC_SYNTHETIC, "compactOnAllocation", "(L" + collections
					+ "api/HugeAllocation;J)V", null, null);
			mv.visitCode();
			final Label l0 = new Label();
			mv.visitLabel(l0);
			mv.visitLineNumber(29, l0);
		...
		{
			mv = cw.visitMethod(ACC_PROTECTED + ACC_BRIDGE + ACC_SYNTHETIC, "createAllocation", "(L" + collections
					+ "impl/MappedFileChannel;)L" + collections + "api/HugeAllocation;", null, null);
			mv.visitCode();
			final Label l0 = new Label();
			mv.visitLabel(l0);
			mv.visitLineNumber(29, l0);
			mv.visitVarInsn(ALOAD, 0);
			mv.visitVarInsn(ALOAD, 1);
			mv.visitMethodInsn(INVOKEVIRTUAL, name + "ArrayList", "createAllocation", "(L" + collections
					+ "impl/MappedFileChannel;)L" + name + "Allocation;");
			mv.visitInsn(ARETURN);
			final Label l1 = new Label();
			mv.visitLabel(l1);
			mv.visitLocalVariable("this", "L" + name + "ArrayList;", null, l0, l1, 0);
		...
		}
		{
			...
			for (final FieldModel fm : tm.fields()) {
				...
				if (fm instanceof ObjectFieldModel) {
					...
					mv.visitMethodInsn(INVOKESTATIC, fm.bcModelType(), "newArrayOfField", "(IL" + collections
							+ "impl/MappedFileChannel;)" + fm.bcLStoreType());
				}
	...
	public static byte[] dumpElement(final TypeModel tm) {
		...
		cw.visit(V1_5, ACC_PUBLIC + ACC_SUPER, name + "Element", "L" + collections + "impl/AbstractHugeElement<L"
				+ name + "Allocation;>;L" + name + ";Ljava/io/Externalizable;", collections
				+ "impl/AbstractHugeElement", new String[] { name, "java/io/Externalizable" });
		...
		{
			mv = cw.visitMethod(ACC_PUBLIC, "<init>", "(L" + collections + "impl/AbstractHugeArrayList;J)V", "(L"
					+ collections + "impl/AbstractHugeArrayList<L" + name + ";L" + name + "Allocation;L" + name
					+ "Element;>;J)V", null);
			mv.visitCode();
			final Label l0 = new Label();
			mv.visitLabel(l0);
			...
			mv.visitVarInsn(ALOAD, 1);
			mv.visitVarInsn(LLOAD, 2);
			mv.visitMethodInsn(INVOKESPECIAL, collections + "impl/AbstractHugeElement", "<init>", "(L" + collections
					+ "impl/AbstractHugeContainer;J)V");
			final Label l1 = new Label();
			mv.visitLabel(l1);
			...
			mv.visitLocalVariable("list", "L" + collections + "impl/AbstractHugeArrayList;", "L" + collections
					+ "impl/AbstractHugeArrayList<L" + name + ";L" + name + "Allocation;L" + name + "Element;>;", l0,
					l2, 1);
		...
		for (final FieldModel fm : tm.fields()) {
			...
			if (fm.virtualGetSet()) {
				mv.visitVarInsn(ALOAD, 0);
				mv.visitFieldInsn(GETFIELD, name + "Element", "container", "L" + collections
						+ "impl/AbstractHugeContainer;");
		...
		}
		{
			...
			mv.visitMethodInsn(INVOKEVIRTUAL, collections + "impl/AbstractHugeContainer", "getAllocation", "(J)L"
					+ collections + "api/HugeAllocation;");
			mv.visitTypeInsn(CHECKCAST, name + "Allocation");
	...
	private static void appendToStringHashCodeEqualsCopyOf(final TypeModel tm, final ClassWriter cw, final String name2,
			final boolean hasListField) {
		final String name = tm.bcType();
		MethodVisitor mv;
		{
			...
			for (final FieldModel fm : tm.fields()) {
				...
				mv.visitMethodInsn(INVOKEVIRTUAL, "java/lang/StringBuilder", "append", "(" + appendType
		...
		}
		{
			...
			for (final FieldModel fm : tm.fields()) {
				if (!fm.copySimpleValue() || !hasListField) {
					...
					mv.visitMethodInsn(INVOKEVIRTUAL, name2, "set" + fm.titleFieldName(), "(" + fm.bcLFieldType()
							+ ")V");
				} else {
		...
		{
			mv = cw.visitMethod(ACC_PUBLIC, "readExternal", "(Ljava/io/ObjectInput;)V", null, new String[] {
	...
	public static byte[] dumpImpl(final TypeModel tm) {
		...
		cw.visit(V1_5, ACC_PUBLIC + ACC_SUPER, name + "Impl", "Ljava/lang/Object;L" + name + ";L" + collections
				+ "api/HugeElement<L" + name + ";>;Ljava/io/Externalizable;", "java/lang/Object", new String[] { name,
				collections + "api/HugeElement", "java/io/Externalizable" });
...

		{
			...
			mv.visitFieldInsn(GETSTATIC, collections + "api/HugeElementType", "BeanImpl", "L" + collections
					+ "api/HugeElementType;");
			mv.visitInsn(ARETURN);
			final Label l1 = new Label();
			mv.visitLabel(l1);
